...
** TODO BUG: Signup doesn't take a display name or email address
** TODO BUG: Logging in with no profile should take you to profile creation
** TODO BUG: Well, creating a new account should also take the profile too
